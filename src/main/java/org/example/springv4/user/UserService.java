...
import org.example.springv4.core.error.ex.Exception401;
import org.example.springv4.core.error.ex.Exception400;
import org.example.springv4.core.error.ex.Exception404;
import org.example.springv4.core.util.JwtUtil;
import org.example.springv4.core.util.MyFile;
...
public class UserService {
    ...
    public String 로그인(UserRequest.LoginDTO loginDTO) {
        ...
        //2. 조회가 되면, JWT 만들고 응답하기 -> 자주 사용할 것이므로 Util로 뺀다.
